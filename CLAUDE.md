# Junior Insight 콘텐츠 상태 점검 SKILL

**앱**: https://junior-insight.vercel.app | **Repo**: `dearmysoul/Junior-Insight` | **점검 대상**: `public/news.json`

> 이 루틴의 역할이 **바뀌었습니다**. 이제 콘텐츠 생성은 GitHub Actions
> 워크플로 "Daily Content Generate"(`.github/workflows/fetch-news.yml`)가
> 매일 자동으로 담당합니다. **이 루틴은 콘텐츠를 만들지 않습니다.**
...
- 실패하면(캐시/배포 지연) 30초 뒤 1회 재시도. 그래도 실패면 STEP 4의 "가져오기 실패"로 알림.
